...
function logDrop(mult){var chip=document.createElement("span");chip.className="drop-chip-ba4ae8a7"+
...
function say(text,mood){noteEl.textContent=text;noteEl.classList.remove("drop-note-up","drop-note-down");if(mood==="up"){noteEl.classList.add("drop-note-up-ba4ae8a7");}else if(mood==="down"){noteEl.classList.add("drop-note-down-ba4ae8a7");}}
